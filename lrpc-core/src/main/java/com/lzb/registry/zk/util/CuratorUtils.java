...
public final class CuratorUtils {
    ...
    public static void createPersistentNode(CuratorFramework zkClient, String path) {
        try {
            if (REGISTERED_PATH_SET.contains(path) || zkClient.checkExists().forPath(path) != null) {
                ...
                //eg: /my-rpc/com.lzb.HelloService/127.0.0.1:9999
     ...
     *
     * @param rpcServiceName rpc service name eg:com.lzb.HelloServicetest2version1
     ...
     *
     * @param rpcServiceName rpc service name eg:com.lzb.HelloServicetest2version
     */
